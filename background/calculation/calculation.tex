...
\subsection{Error on Average Field}
...
%\subsection{A Note on the Error Calculation}
%
%If $\Delta C_n$ is non-zero, we get the additional term in the error calculation
%
%\begin{equation}
%\zeta^2_{nt} =
%(\frac{d \left\langle B \right\rangle_{nt}}{dC_{n}}\Delta C_{n})^2
%\end{equation}
%or 
%\begin{equation}
%\zeta^2_{nt} =
%(\frac{-w_n b_{nt} m_{nt} c_{nt} \Delta C_n }{C^2_n})^2
%\end{equation}
%which gives
%\begin{equation}
%\zeta^2_{n} =
%\Sigma_t(\frac{-w_n b_{nt} m_{nt} c_{nt} \Delta C_n }{C^2_n})^2 = 
%\frac{w^2_n \Delta C^2_n}{C^4_n} \Sigma_t(b_{nt} m_{nt} c_{nt})^2
%\end{equation}
%which gives
%\begin{equation}
%\zeta^2 =
%\Sigma_n \frac{w^2_n \Delta C^2_n}{C^4_n} \Sigma_t(b_{nt} m_{nt} c_{nt})^2
%\end{equation}
%but if $C_n = C$ and $\Delta C_n = C$, and $c_{nt} = c_t$ we get
%\begin{equation}
%\zeta^2 =
%\frac{\Delta C^2}{C^4} \Sigma_n w^2_n \Sigma_t(b_{nt} m_{nt} c_{t})^2
%\end{equation}
